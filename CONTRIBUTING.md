# Contributing to epazote

First and foremost, thank you! We appreciate that you want to contribute to
**epazote**, your time is valuable, and your contributions mean a lot to us.
...
- star the [project](https://github.com/nbari/epazote)
...
- **version**: please note the version of **epazote** are you using
- **extensions, plugins, helpers, etc** (if applicable): please list any extensions you're using
- **error messages**: please paste any error messages into the issue, or a [gist](https://gist.github.com/)

### Closing issues

The original poster or the maintainer's of **epazote** may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/epazote
